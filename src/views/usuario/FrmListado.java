...
public class FrmListado extends JFrame {
	...
	public FrmListado() {
		...
		btnEliminar.setBounds(31, 111, 45, 33);
		...
		btnEditar.setBounds(85, 111, 45, 33);
	...
	private String[][] obtenerMatriz() {
		...
		try {
			UsuarioBeanRemote uBean = (UsuarioBeanRemote) InitialContext.doLookup("ejb:/IAGROEJB/UsuarioBean!services.UsuarioBeanRemote");
