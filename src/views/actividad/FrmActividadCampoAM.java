...
public class FrmActividadCampoAM extends JFrame {
	...
	public FrmActividadCampoAM(AccionFormulario accion, Usuario u, Long idAc) {
		...
		lblNewLabel_2.setIcon(
				new ImageIcon(FrmActividadCampoAM.class.getResource("/views/assets/icons/icon-app-ventana.png")));
		...
		lblCerrarSesion.setBounds(874, 4, 29, 28);
		...
		txtTitulo.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		...
		lblNewLabel_1_1.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		...
		lblNewLabel_1_1_2.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		...
		taDescripcion.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		...
		jtable_param.setGridColor(Color.BLACK);
		jtable_param.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		jtable_param.setModel(
				new DefaultTableModel(new Object[][] {}, new String[] { "Identificador", "Título", "Descripción" }));
		scrollPaneParam.setViewportView(jtable_param);
		construirTabla();

		JDateChooser fechaInicio = new JDateChooser();
		fechaInicio.setBounds(31, 365, 330, 20);
				...
				if (row >= 0) {
					...
					try {
						...
						if (AccionFormulario.Modificar.equals(accion)) {
							...
							JOptionPane.showMessageDialog(null, "Actividad de campo modificada con éxito");
						} else {
					...
					JOptionPane.showMessageDialog(null, "Usted debe seleccionar del listador un formulario",
							"Modificar actividad de campo", JOptionPane.ERROR_MESSAGE);
				}
	...
	public void construirTabla() {
		...
		String titulos[] = { "Identificador", "Título", "Descripción" };
		...
		jtable_param.setSelectionForeground(Color.WHITE);
		jtable_param.setFont(new Font("Gill Sans MT", Font.PLAIN, 14));
		jtable_param.setBackground(Color.WHITE);
		scrollPaneParam.setViewportView(jtable_param);
