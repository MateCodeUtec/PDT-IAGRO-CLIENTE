...
public class FrmActividadCampoView extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FrmActividadCampoView(AccionFormulario accion, Long idActividad) {
		...
		//Cargo datos del formulario asociado a la actividad
		ActividadCampo ac = actividadBean.getActividadById(idActividad);
		Formulario f = formularioBean.getFormularioById(ac.getFormulario().getId());
		...
		//Convierto el Set a Arraylist
		List<Parametro> listaParam = new ArrayList<Parametro>();
		listaParam.addAll(f.getParametros());
